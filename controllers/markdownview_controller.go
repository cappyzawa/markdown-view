...
//+kubebuilder:rbac:groups=view.cappyzawa.github.io,resources=markdownviews/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=view.cappyzawa.github.io,resources=markdownviews/finalizers,verbs=update
